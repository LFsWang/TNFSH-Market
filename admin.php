...
$allow_page = array('index','goods','edit_system_announcement','goodlists','editimg','admininfo','listadmin','goodlists_summary','good_summary','admininfoedit','syslog','saccount_groups','addastudent','orderfind','orderview');
$page = 'index';
