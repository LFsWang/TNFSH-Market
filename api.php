...
$case = array( 'getgoodinfo' , 'getgoodlist' , 'editimage', 'delimage' , 'addadmin' ,'addsgroup','addsastudent','modifyastudent','delorder','cg-num','modifysgroup','importacct','importclass');
if( in_array($action,$case) )
{
